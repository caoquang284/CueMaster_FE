                ...
                return (
                  ...
                  >
                    <TableCell className="font-medium">
                      {booking.table?.code || booking.tableId}
                    </TableCell>
                    <TableCell>
        ...
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle className="text-2xl">
              Booking Details #{detailBooking?.id.slice(0, 8)}
            </DialogTitle>
          </DialogHeader>
          {detailBooking && (
              ...
              <div className="space-y-6">
                ...
                <div className="border rounded-lg p-4 bg-slate-50 dark:bg-slate-800">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <Badge
                      variant={!detailBooking.userId ? "secondary" : "default"}
                    >
                  ...
                  <div className="space-y-3">
                    <div>
                      ...
                      <p className="font-medium">
                        {!detailBooking.userId
                          ? detailBooking.guestName || "N/A"
                          : detailBooking.user?.name || "N/A"}
                      </p>
                    </div>
                    <div>
                      ...
                      <p className="font-medium">
                        {!detailBooking.userId
                          ? detailBooking.guestEmail || "N/A"
                          : detailBooking.user?.email || "N/A"}
                      </p>
                    </div>
                    <div>
                      <Label className="text-xs text-slate-500">Phone</Label>
                      <p className="font-medium">
                        {detailBooking.guestPhone || "N/A"}
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between items-center">
                      ...
                      <p className="font-bold text-lg">
                        {detailBooking.table?.code} -{" "}
                        {detailBooking.table?.type}
                      </p>
                    </div>
                    <div className="flex justify-between items-center">
                      ...
                      <p className="font-medium">
                        {(
                          ...
                          ((new Date(detailBooking.endTime).getTime() -
                            new Date(detailBooking.startTime).getTime()) /
                            (1000 * 60 * 60))
                        ).toFixed(1)}
                        đ/hour
                      </p>
                ...
                <div className="border rounded-lg p-4 bg-slate-50 dark:bg-slate-800">
                  ...
                  <div className="space-y-3">
                    ...
                    <div>
                      ...
                      <p className="font-medium text-base">
                        {formatDateTime(detailBooking.endTime)}
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="border rounded-lg p-4 bg-slate-50 dark:bg-slate-800">
                  <div className="grid grid-cols-2 gap-3 text-xs">
                    ...
                    <div>
                      ...
                      <p className="font-medium">
                        {new Date(detailBooking.updatedAt).toLocaleDateString(
                          "vi-VN",
                        )}
                      </p>
                    </div>
