  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-slate-400">Manage billiard tables and their status</p>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
            {filteredTables.map((table) => (
              <div
                key={table.id}
                className={cn(
                  'p-5 rounded-lg border-2 transition-all duration-300 hover:shadow-lg',
              ...
              >
                <div className="flex items-start justify-between mb-3">
                  <div>
                    ...
                    <p className="text-sm text-slate-400">{table.type}</p>
                  </div>
